            ...
            <div className="text-white">
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="bg-black/50 backdrop-blur-sm p-4 rounded-lg border border-amber-500/30">
                  ...
                  <p className="text-lg font-bold">60+ ACRES OF LAND</p>
                </div>
                <div className="bg-black/50 backdrop-blur-sm p-4 rounded-lg border border-amber-500/30">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {[
              ...
              { type: 'Commercial Plots', price: '₹38,500', unit: 'per sq.yd', description: 'Strategic commercial plots for business growth' }
            ].map((plot, index) => (
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <article className="bg-gray-50 p-6 rounded-xl" itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                ...
                <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <p className="text-gray-600" itemProp="text">
                    Golden City plots start from ₹38,500 per square yard for residential plots and go up to ₹38,500 per square yard for commercial plots. We offer flexible payment plans and bank loan facilities.
                  </p>
                </div>
              </article>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 text-sm text-gray-600 leading-relaxed">
              <div>
                ...
                <p className="mb-4">
                  Our <strong>Golden City Phase 1</strong> and <strong>Golden City Phase 2</strong> developments feature <strong>residential plots near Jewar Airport</strong> starting from just ₹38,500 per square yard, with <strong>commercial plots near Noida International Airport</strong> available for business investments. All plots come with <strong>bank loan available</strong> options and <strong>immediate possession</strong>.
                </p>
              </div>
